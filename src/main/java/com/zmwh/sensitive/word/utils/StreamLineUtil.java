 ...
 */
package com.zmwh.sensitive.word.utils;
 ...
 */
public class StreamLineUtil {
    private StreamLineUtil() {
    }
     ...
     * @since 0.1.67
     */
    public static Set<String> readAllLines(final String path) {
     ...
     * @since 0.1.67
     */
    public static Set<String> readAllLines(final InputStream is) {
     ...
     * @since 0.1.67
     */
    public static Set<String> readAllLines(InputStream is,
                                            final String charset,
